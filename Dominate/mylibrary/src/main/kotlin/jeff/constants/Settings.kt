...
import jeff.utils.FileUtils.getRootDir
...
object Settings {
    ...
    //var DEBUGMODE = true
//保存根目录文件地址
    var ROOT_DIR: String = getRootDir;//在Application初始化中赋值，其他地方直接调用即可
    //保存文件
    var FILE_PATH:String= "${ROOT_DIR}/${APP_NAME}/"

    //CRASH保存的异常文件目录和文件名称
    var CRASH_FILE_PATH: String? = "${FILE_PATH}crash/";//保存文件地址，有可能为空
    ...
    var LOG_FILE_PATH: String? = "${FILE_PATH}log/";//保存文件地址，有可能为空
