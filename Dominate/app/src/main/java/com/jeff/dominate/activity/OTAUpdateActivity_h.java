 ...
 * <p>
 * 在开始OTA或者MeshOTA之前都会获取当前设备的OTA状态信息 {@link MeshOTAActivity#sendGetDeviceOtaStateCommand()},
 * \n\t 并通过 {@link MeshOTAActivity#onNotificationEvent(NotificationEvent)}返回状态， 处理不同模式下的不同状态
 * 在continue MeshOTA和MeshOTA模式下 {@link MeshOTAActivity#MODE_CONTINUE_MESH_OTA},{@link MeshOTAActivity#MODE_MESH_OTA}
 * <p>
 * <p>
 * 校验通过后，会开始动作
 * <p>
