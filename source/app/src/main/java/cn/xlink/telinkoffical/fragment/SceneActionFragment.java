...
public class SceneActionFragment extends BaseFragment {
    ...
    @Bind(R.id.view_scene_action_scrollview)
    MyScrollview scrollview;

    @Bind(R.id.act_scene_devicelist)
    RecyclerView recyclerView;

    @Bind(R.id.act_scene_listtips)
    TextView tipsTextView;

    @Bind(R.id.scene_select_button)
    ToggleButton toggleButton;

    @Bind(R.id.view_scene_bottom)
    View viewButton;
