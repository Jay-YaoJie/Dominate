...
package cn.xlink.telinkoffical.database.utils;
...
public class UpgradeHelper extends DaoMaster.OpenHelper {
    ...
    public void onUpgrade(SQLiteDatabase db, int oldVersion, int newVersion) {
        ...
        for (int i = oldVersion; i < newVersion; i++) {
            ...
            MigrationHelper.getInstance().migrate(db, UserDao.class, SceneSortDao.class, PlaceSortDao.class,
                    LightSortDao.class, GroupSortDao.class);
        }
