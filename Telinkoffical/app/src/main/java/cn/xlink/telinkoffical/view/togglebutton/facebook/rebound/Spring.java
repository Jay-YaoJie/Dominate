...
package cn.xlink.telinkoffical.view.togglebutton.facebook.rebound;
...
public class Spring {
  ...
  /**
   * icon_check if the current state is at rest
  ...
  /**
   * Set the spring to be at rest by making its end value equal to its current value and icon_setting
   * velocity to 0.
   */
