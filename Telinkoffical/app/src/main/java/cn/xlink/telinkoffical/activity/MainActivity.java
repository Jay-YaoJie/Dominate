...
import cn.xlink.telinkoffical.fragment.BulbsListFragment;
import cn.xlink.telinkoffical.fragment.GroupListFragment;
import cn.xlink.telinkoffical.fragment.HomeFragment;
import cn.xlink.telinkoffical.fragment.SceneListFragment;
...
import cn.xlink.telinkoffical.service.RefreshTokenService;
...
import cn.xlink.telinkoffical.view.SlideMenu;
...
public class MainActivity extends BaseActivity implements EventListener {
    ...
    @Bind(R.id.main_sliding_ota)
    View otaItem;

    @Bind(R.id.main_sliding_ota_reddot)
    TextView reddot;

    @Bind(R.id.main_sliding_name_tips)
    TextView nameTips;

    @Bind(R.id.main_sliding_name)
    TextView accountName;

    @Bind(R.id.main_sliding_button)
    TextView logButton;
