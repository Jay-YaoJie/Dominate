...
public class SharedPreferencesUtil {
    ...
    public static Integer queryIntValue(String key , int defaultV) {
        int value = MyApp.sharedPreferences.getInt(key, defaultV);
    ...
    public static boolean queryBooleanValue(String key, boolean defaultValue) {
        return MyApp.sharedPreferences.getBoolean(key, defaultValue);
    }
