...
import cn.xlink.telinkoffical.adapter.IntroductionPagerAdapter;
...
import cn.xlink.telinkoffical.view.MaterialProgressDrawable;
import cn.xlink.telinkoffical.view.ProgressView;
...
public class FindNewActivity extends BaseActivity implements View.OnClickListener {
    ...
    @Bind(R.id.act_find_new_title)
    TitleBar titleBar;

    @Bind(R.id.act_findnew_viewpager)
