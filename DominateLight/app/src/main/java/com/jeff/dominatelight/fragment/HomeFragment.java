...
import com.jeff.dominatelight.activity.*;
...
import com.jeff.dominatelight.view.MyToast;
...
public class HomeFragment extends BaseFragment {
    ...
    @BindView(R.id.fgt_home_scenelist)
    RecyclerView sceneListView;

    @BindView(R.id.fgt_home_grouplist)
    RecyclerView groupListView;

    @BindView(R.id.fgt_home_group_add)
    View addGroupView;

    @BindView(R.id.fgt_home_devicelist)
    RecyclerView deviceListView;

    @BindView(R.id.fgt_home_device_add)
    View addDeviceView;
