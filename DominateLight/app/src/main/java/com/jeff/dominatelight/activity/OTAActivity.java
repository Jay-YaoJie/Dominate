...
public class OTAActivity extends BaseActivity implements EventListener{
    ...
    @BindView(R.id.act_ota_title)
    TitleBar titleBar;

    @BindView(R.id.act_ota_item1)
    View hadOtaView;

    @BindView(R.id.act_ota_item2)
    View noHadOtaView;

    @BindView(R.id.act_ota_had)
    View canOtaView;

    @BindView(R.id.act_ota_no_had)
    View notOtaView;

    @BindView(R.id.act_ota_had_recyclerview)
    RecyclerView canRecyclerView;

    @BindView(R.id.act_ota_no_had_recyclerview)
    RecyclerView notRecyclerView;

    @BindView(R.id.item_ota_button)
    TextView button;
